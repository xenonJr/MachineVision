...
while True:
    ...
    for i, c in enumerate(contours):
        ...
        # if area < 60000 or 100000 < area:    #works for full size
        #     continue

        if area < 10000 or 100000 < area:  # works for full size
            continue
        ...
        textbox = cv.rectangle(res, (center[0] - 35, center[1] - 25),
                               (center[0] + 295, center[1] + 10), (255, 255, 255), -1)
        cv.putText(res, label, (center[0] - 50, center[1]),
                   cv.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 1, cv.LINE_AA)
        if angle < -10:
            cv.putText(res, "LEFT", (50, 80), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
        elif angle > 10:
            cv.putText(res, "RIGHT", (50, 80), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
